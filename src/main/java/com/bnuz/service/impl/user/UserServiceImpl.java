...
public class UserServiceImpl extends BaseServiceImpl<UserDto, String> implements UserService {
     ...
     */
    @Override
    public Result register(UserDto userDto, String ip) throws Exception {
        // 如果手机号为空
     ...
     */
    @Override
    public Result updateUserInfoByUser(UserDto userDto) throws Exception {
    ...
    @Override
    public Result getUserByID(String uid) throws Exception {
