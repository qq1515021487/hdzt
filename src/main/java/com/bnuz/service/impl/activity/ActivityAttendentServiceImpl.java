...
public class ActivityAttendentServiceImpl extends BaseServiceImpl<ActivityAttendentDto, String>
     ...
     */
    @Override
    public Result loginByMiniProgram(String code, String ip) {
        try {
     ...
     */
    @Override
    public ActivityAttendentInfoDto register(String wechatOpenId) {
    ...
    @Override
    public ActivityAttendentInfoDto getAttendentInfoByAttendentId(String attendentId) {
        return activityAttendentInfoRepository.findByAttendentId(attendentId);
    }

    @Override
    public Result updateAttendentInfo(String attendentId, ActivityAttendentInfoDto activityAttendentInfoDto) {
        ...
        try {
            ...
            e.printStackTrace();
            return Result.fail("出现了一些小BUG", ErrorCode.BAD_REQUEST);
        }
