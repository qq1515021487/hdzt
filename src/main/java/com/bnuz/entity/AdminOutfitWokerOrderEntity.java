...
@Entity
@Table(name = "t_admin_outfit_woker_order", schema = "hdzt")
public class AdminOutfitWokerOrderEntity {
    ...
    public boolean equals(Object o) {
        ...
        AdminOutfitWokerOrderEntity that = (AdminOutfitWokerOrderEntity) o;
        ...
        if (checkerAuid != null ? !checkerAuid.equals(that.checkerAuid) : that.checkerAuid != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (checkerAuid != null ? checkerAuid.hashCode() : 0);
        return result;
    }
}